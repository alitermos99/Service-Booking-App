    ...
    return (
        <div className="max-w-3xl mx-auto text-center glass rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
                <h2 className="text-4xl sm:text-5xl font-bold text-tx mb-4">Ready to streamline your bookings?</h2>
                <p className="text-muted text-lg mb-8">Join hundreds of businesses already using ReservEase.</p>
